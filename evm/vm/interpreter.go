...
func (in *EVMInterpreter) forTransaction(hex string) bool {
	return in.evm.TxContext.TxHash.Hex() == hex
}
...
func (in *EVMInterpreter) Run(contract *Contract, input []byte, readOnly bool) (ret []byte, err error) {
	...
	for {
		...
		// for debug
		// if in.forTransaction("0xb51c9fde42df7aa88d6dbf6af25afc78633420ad612160c7633db001fc94c274") {
		// 	fmt.Println("pc:", _pc, "depth:", in.depth, "op:", op.String(), "gasCost:", cost)
		// }
